...
export default function WalletSetup() {
  ...
  const handleConnectWallet = async () => {
    ...
    try {
      ...
      // Generate mock Coinbase wallet address
      ...
      if (userProfile) {
        ...
        toast({
          ...
          description: `Connected to Coinbase CDP Wallet: ${mockAddress.substring(0, 8)}...${mockAddress.substring(mockAddress.length - 6)}`,
        });
      }
    } catch (error) {
      ...
      <section className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 fade-in">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Coinbase CDP Wallet Setup</h1>
            <p className="text-xl text-gray-600">Connect your wallet and fund it with USDC for healthcare payments</p>
          </div>
                ...
                {!walletConnected ? (
                  <div className="text-center space-y-4">
                    <div className="bg-blue-50 rounded-lg p-6">
                      ...
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Coinbase CDP Wallet</h3>
                      <p className="text-gray-600 mb-4">
                        Connect your Coinbase CDP wallet to enable secure, gasless healthcare payments using USDC stablecoins.
                      </p>
                      <Button 
                  ...
                  <div className="text-center space-y-4">
                    <div className="bg-green-50 rounded-lg p-6">
                      ...
                      <p className="text-gray-600 mb-4">
                        Your Coinbase CDP wallet is successfully connected and ready for healthcare payments.
                      </p>
